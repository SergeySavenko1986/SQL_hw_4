    ...
    with psycopg2.connect(database="1", user="postgres",
        ...
        with conn.cursor() as curs:
            ...
            print("Добавлен клиент id: ",
                  insert_client(curs, "Иван", "Иванов", "ivanov@mail.ru"))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Петр", "Петров",
                                "petrov@mail.ru", 79993318644))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Василий", "Васильев",
                                "vasiliev@mail.ru", 79933314644))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Павел", "Павлов",
                                "pavlov@mail.ru", 79913312643))
            print("Добавлена клиент id: ",
                  insert_client(curs, "Николай", "Николаев",
                                "nikolayev@mail.ru"))
            ...
            print("Изменены данные клиента id: ",
                  update_client(curs, 4, "Федор", None, '123@mail.ru'))
            ...
            pprint(find_client(curs, 'Василий'))

            print('Найденный клиент по email:')
            pprint(find_client(curs, None, None, 'ivanov@mail.ru'))

            print('Найденный клиент по имени, фамилии и email:')
            pprint(find_client(curs, 'Иван', 'Иванов',
                               'ivanov@mail.ru'))

            print('Найденный клиент по имени, фамилии, телефону и email:')
            pprint(find_client(curs, 'Петр', 'Петров',
                               'petrov@mail.ru', '79993318644'))
